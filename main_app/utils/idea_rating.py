...
comments = ['Очень интересная идея', "Плохо написанный проект", "Полное фуфло ваши идеи", "Редкое говно!", "Мне нравится Ваш подход!", "Очень хорошо", "Так держать!", "Вырви себе руки"]
